...
var sediff = require( './../lib/sediff.js' );
...
tape( 'the function has an arity of 11', function test( t ) {
	t.strictEqual( sediff.length, 11, 'returns expected value' );
	t.end();
});
...
tape( 'the function calculates differences between consecutive elements of a single-precision floating-point strided array', function test( t ) {
	...
	out = sediff( x.length, x, 1, 2, p, 1, 2, a, 1, o, 1 );
...
tape( 'if the sum of the `N`, `N1`, and `N2` parameters is less than or equal to `1`, the function returns `out` unchanged', function test( t ) {
	...
	out = sediff( 1, x, 1, 0, p, 1, 0, a, 1, o, 1 );
	expected = new Float32Array([
		0.0,
		0.0,
		0.0,
...
tape( 'the function supports stride parameters', function test( t ) {
	...
	out = sediff( 3, x, 2, 2, p, 2, 2, a, 2, o, 2 );
	expected = new Float32Array([
		10.0,
		0.0,
		25.0,
...
tape( 'the function supports no prepend and no append', function test( t ) {
	...
	out = sediff( x.length, x, 1, 0, p, 1, 0, a, 1, o, 1 );
...
tape( 'the function supports multiple prepend and append values', function test( t ) {
	...
	out = sediff( x.length, x, 1, 2, p, 1, 0, a, 1, o, 1 );
	...
	out = sediff( x.length, x, 1, 1, p, 1, 2, a, 1, o, 1 );
...
tape( 'the function supports append without prepend', function test( t ) {
	...
	out = sediff( x.length, x, 1, 0, p, 1, 1, a, 1, o, 1 );
